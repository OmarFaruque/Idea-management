...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({"row":"im_rowIe5G9"});
...
/* harmony import */ var _idea_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./idea.scss */ "./src/idea.scss");
...
(0,vue_dist_vue_esm_bundler__WEBPACK_IMPORTED_MODULE_0__.createApp)({
  data: function data() {
    return {
      message: 'Hello Vue!',
      idea_types: [],
      style: _idea_scss__WEBPACK_IMPORTED_MODULE_1__["default"],
      idea_type: '',
      title: '',
      content: '',
      file: ''
  ...
  methods: {
    ...
    formSubmit: function formSubmit() {
      ...
      var data = {
        ...
        content: this.content // file: formData
      ...
      axios__WEBPACK_IMPORTED_MODULE_3___default().get('https://api.coindesk.com/v1/bpi/currentprice.json').then(function (response) {
