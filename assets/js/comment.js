...
/* harmony import */ var _comment_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./comment.scss */ "./src/comment.scss");
/* harmony import */ var _utils_fetchWP__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils/fetchWP */ "./src/utils/fetchWP.js");



var fetchWP = new _utils_fetchWP__WEBPACK_IMPORTED_MODULE_2__["default"]({
...
(0,vue_dist_vue_esm_bundler__WEBPACK_IMPORTED_MODULE_0__.createApp)({
  data: function data() {
    return {
      style: _comment_scss__WEBPACK_IMPORTED_MODULE_1__["default"],
  ...
  methods: {
    fetchData: function fetchData() {
      ...
      fetchWP.post('getcomments/', data).then(function (json) {
        console.log('json comments: ', json);
        _this.comments = json.comments;
        _this.user_vote_status = json.user_vote_status;
        _this.p_vote_id = json.p_vote_id;
        _this.loader = false;
      })["catch"](function (error) {
        console.log('error', error);
      });
    },
    commentFilter: function commentFilter() {
    ...
    formSubmit: function formSubmit() {
      ...
      fetchWP.post('postcomment/', data).then(function (json) {
        _this3.comments = json.comments;
        _this3.loader = false;
      })["catch"](function (error) {
        console.log('error', error);
      });
